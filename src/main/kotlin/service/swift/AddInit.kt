...
class AddInit : IMyPluginActionDelegate {
    // ˅
    ...
    override fun editElements(elements: List<INamedElement>) {
        ...
        elements.forEach {
            ...
            val initializer = basicModelEditor.createOperation(it as IClass, "init", "")
            println("Added initializer :".plus(initializer.getFullName(".").plus("()")))
        }
        // ˄
    }
