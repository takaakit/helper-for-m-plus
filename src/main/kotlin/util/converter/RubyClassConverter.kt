...
// Convert the Ruby class type of the target class.
class RubyClassConverter(targetClass: IClass) {
    // ˅
    ...
    fun isRubyClassKind(kinds: List<ClassKind>): Boolean {
        // ˅
    ...
    fun convertRubyClassKind(kinds: List<ClassKind>) {
        // ˅
