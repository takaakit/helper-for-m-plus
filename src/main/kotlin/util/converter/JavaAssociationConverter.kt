...
// Convert the Java association type of the target association.
class JavaAssociationConverter(targetAssociation: IAssociation) {
    // ˅
    ...
    fun isJavaCollectionKind(kinds: List<CollectionKind>): Boolean {
        // ˅
    ...
    fun convertJavaCollectionKind(kinds: List<CollectionKind>) {
        // ˅
