...
// Convert the TypeScript association type of the target association.
class TypescriptAssociationConverter(targetAssociation: IAssociation) {
    // ˅
    ...
    fun isTypescriptCollectionKind(kinds: List<CollectionKind>): Boolean {
        // ˅
    ...
    fun convertTypescriptCollectionKind(kinds: List<CollectionKind>) {
        // ˅
