...
// Convert the Kotlin class type of the target class.
class KotlinClassConverter(targetClass: IClass) {
    // ˅
    ...
    fun isKotlinClassKind(kinds: List<ClassKind>): Boolean {
        // ˅
    ...
    fun convertKotlinClassKind(kinds: List<ClassKind>) {
        // ˅
