...
// Convert the Swift class type of the target class.
class SwiftClassConverter(targetClass: IClass) {
    // ˅
    ...
    fun isSwiftClassKind(kinds: List<ClassKind>): Boolean {
        // ˅
    ...
    fun convertSwiftClassKind(kinds: List<ClassKind>) {
        // ˅
