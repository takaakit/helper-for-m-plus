...
// Convert the Alloy class type of the target class.
class AlloyClassConverter(targetClass: IClass) {
    // ˅
    ...
    fun isAlloyClassKind(kinds: List<ClassKind>): Boolean {
        // ˅
    ...
    fun convertAlloyClassKind(kinds: List<ClassKind>) {
        // ˅
