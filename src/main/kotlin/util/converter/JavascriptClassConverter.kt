...
// Convert the JavaScript class type of the target class.
class JavascriptClassConverter(targetClass: IClass) {
    // ˅
    ...
    fun isJavascriptClassKind(kinds: List<ClassKind>): Boolean {
        // ˅
    ...
    fun convertJavascriptClassKind(kinds: List<ClassKind>) {
        // ˅
